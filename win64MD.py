...
class master_form_find():
    ...
    def getDataList(self, event = None):
        ...
        if self.isRec:
            listItems = loads(self.data.searchRecettes(wrd, indI, cat))
            colW = [10, 3, 3, 3, 3, 1]
            ...
            if wrd == '' and cat == 0:
                ...
                return        
            listItems = loads(self.data.searchClubs(wrd, indI, cat))
    ...
    def webCall(self, e):
        id = e.widget._values
        url = "https://cdore.ddns.net/ficheClub.html?data=" + str(id)
