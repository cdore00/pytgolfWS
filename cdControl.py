...
class messageObj():
    def __init__(self, parent, objToBind = None, *args, **kwargs):
        self.objToBind = objToBind
        self.messframe = tk.Frame(parent, height=0)
        self.messframe.pack(expand= True, fill=BOTH)
        self.messLabel = None      

    def showMess(self, message):
        self.messLabel = tk.Label(self.messframe, font=('Calibri 12'), fg='#f00')
        self.messLabel.config(text="Enregistré!")
